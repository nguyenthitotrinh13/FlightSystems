...
namespace FlightMicroservice.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        public async Task<IActionResult> RegisterAdmin([FromBody] RegisterModel model)
        {
            ...
            if (!await _roleManager.RoleExistsAsync(UserRoles.Attendant))
                await _roleManager.CreateAsync(new IdentityRole(UserRoles.Attendant));
            ...
            if (await _roleManager.RoleExistsAsync(UserRoles.Attendant))
            {
                await _userManager.AddToRoleAsync(user, UserRoles.Attendant);
            }
